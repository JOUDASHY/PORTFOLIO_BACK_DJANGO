...
def update_template_vars(apps, schema_editor):
...
def reverse_template_vars(apps, schema_editor):
    pass  # pas de rollback necessaire


class Migration(migrations.Migration):

    dependencies = [
        ('core', '0041_projet_is_featured'),
    ]

    operations = [
        migrations.RunPython(update_template_vars, reverse_template_vars),
    ]
